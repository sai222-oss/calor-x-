...
const Progress = () => {
  ...
  return (
    <div className="min-h-screen pb-24" style={{ background: "#F8F8FC" }}>
      <div className="p-4 flex items-center gap-3 text-white" style={{ background: "#6C63FF" }}>
      ...
      {loading ? (
        <div className="flex items-center justify-center py-24"><Loader2 className="w-8 h-8 animate-spin" style={{ color: "#6C63FF" }} /></div>
      ) : (
        <div className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Card className="p-5 text-center premium-card">
              <p className="text-4xl font-black" style={{ color: "#6C63FF" }}>{totalMeals}</p>
          ...
          <Card className="p-5 premium-card">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-bold" style={{ color: "#6C63FF" }}>{t("prog_7day_cal")}</h2>
            </div>
          ...
          <Card className="p-5 premium-card">
            ...
            {goals ? (
              ...
              <p className="text-sm text-muted-foreground text-center py-4">
                {t("prog_setup_goals")} → <button className="underline" style={{ color: "#6C63FF" }} onClick={() => navigate("/profile-setup")}>{t("setup")}</button>
              </p>
            )}
          </Card>
          ...
          <Button
            ...
            style={isPro ? { background: "#6C63FF" } : { background: "#6B7280" }}
