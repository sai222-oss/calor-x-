...
const strings = {
    ...
    dash_daily_streak_badge: { ar: "🔥 أيام متتالية {{n}}", en: "Daily Streak 🔥 {{n}}" },
    dash_ready_crush: { ar: "مستعد لتحقيق أهدافك اليوم؟ هيا لنسجل طعامك! 🚀", en: "Ready to crush your goals today? Let's track some delicious food! 🚀" },
    dash_quick_actions: { ar: "إجراءات سريعة", en: "Quick Actions" },
    dash_smart_advice: { ar: "نصائح ذكية", en: "Smart advice" },
    dash_daily_recipes: { ar: "وصفات يومية", en: "Daily recipes" },
    dash_vitamins: { ar: "فيتامينات", en: "Vitamins" },
    dash_generate_scan: { ar: "مسح جديد", en: "Generate Scan" },
    dash_protein_g: { ar: "جم بروتين", en: "g protein" },
    ...
    scan_err_camera: { ar: "تعذر الوصول للكاميرا", en: "Camera access denied" },
    scan_enter_manually: { ar: "إدخال يدوي", en: "Enter Manually" },
    scan_search_food: { ar: "ابحث عن طعام (مثل: شاورما)", en: "Search food (e.g., Shawarma)" },
    scan_change: { ar: "تغيير", en: "Change" },
    scan_typical_portion: { ar: "جم حصة معتادة", en: "g typical portion" },
    scan_no_foods: { ar: "لم يتم العثور على أطعمة. جرب بحثاً مختلفاً.", en: "No foods found. Try a different search." },
    scan_search_placeholder: { ar: "ابحث عن أطباق عربية...", en: "Search for Middle Eastern foods..." },
    scan_enter_weight: { ar: "أدخل الوزن", en: "Enter Weight" },
    scan_grams: { ar: "جرام", en: "grams" },
    scan_calc_nutrition: { ar: "حساب العناصر الغذائية", en: "Calculate Nutrition" },
    scan_upload_image: { ar: "رفع صورة طعام", en: "Upload Food Image" },
    scan_capture: { ar: "التقاط", en: "Capture" },
    scan_change_image: { ar: "تغيير الصورة", en: "Change Image" },
    scan_err_analysis_failed_title: { ar: "فشل تحليل الصورة", en: "Analysis Failed" },
    scan_try_again: { ar: "المحاولة مرة أخرى", en: "Try Again" },
    scan_back_home: { ar: "العودة للرئيسية", en: "Back to Home" },
    ...
    res_ingredient_added: { ar: "تم إضافة المكون!", en: "Ingredient added!" },
    res_high_accuracy_db_match: { ar: "تطابق عالي الدقة", en: "High accuracy Database Match" },
    res_adjust_portions: { ar: "تعديل الكميات", en: "Adjust Portions" },
    res_missing_something: { ar: "هل ينقص شيء؟", en: "Missing Something?" },
    res_missing_something_desc: { ar: "هل فات الذكاء الاصطناعي مكونات مخفية تماماً مثل زيت الزيتون، المرق، أو اللحوم في الطبقة السفلية؟ أضفها يدوياً لتسجيل دقيق!", en: "Did the AI miss completely hidden ingredients like olive oil, broth, or bottom-layer meats? Add them manually to perfect your log!" },
    res_add_hidden_ingredient: { ar: "إضافة مكون مخفي", en: "Add Hidden Ingredient" },
    res_add_ingredient_title: { ar: "إضافة مكون", en: "Add Ingredient" },
    res_search_ingredient: { ar: "ابحث (مثل: زيت زيتون، دجاج، أرز)", en: "Search (e.g., Olive Oil, Chicken, Rice)" },
    res_g_typical: { ar: "جم معتاد", en: "g typical" },
    res_no_items: { ar: "لم يتم العثور على أطعمة.", en: "No items found." },
    res_search_to_add: { ar: "ابحث عن مكونات لإضافتها...", en: "Search for ingredients to add..." },
    res_enter_hidden_weight: { ar: "أدخل الوزن المخفي", en: "Enter Hidden Weight" },
    res_add_to_result: { ar: "إضافة للنتيجة!", en: "Add to Result!" },
    res_save_to_log: { ar: "حفظ بالسجل ({{kcal}} سعرة)", en: "Save to Log ({{kcal}} kcal)" },
    ...
    // ─── Auth ─────────────────────────────────────────────
    auth_check_email: { ar: "تحقق من بريدك الإلكتروني", en: "Check your email" },
    auth_email_verification_required: { ar: "مطلوب التحقق من البريد الإلكتروني", en: "Email Verification Required" },
    auth_verification_sent: { ar: "أرسلنا رابط التحقق إلى بريدك الإلكتروني. يرجى التحقق لمواصلة استخدام التطبيق.", en: "We've sent a verification link to your email address. Please verify your email to continue." },
    auth_must_verify: { ar: "يجب التحقق من بريدك الإلكتروني قبل تسجيل الدخول.", en: "You must verify your email address before you can log in to Calor X. Please check your inbox for the verification link." },
    auth_return_login: { ar: "العودة لتسجيل الدخول", en: "Return to Login" },
    auth_sign_in: { ar: "تسجيل الدخول", en: "Sign In" },
    auth_sign_up: { ar: "إنشاء حساب", en: "Sign Up" },
    auth_sign_in_desc: { ar: "سجل دخولك لحسابك", en: "Sign in to your account" },
    auth_sign_up_desc: { ar: "أنشئ حسابك الجديد", en: "Create your account" },
    auth_continue_google: { ar: "المتابعة باستخدام Google", en: "Continue with Google" },
    auth_or: { ar: "أو", en: "or" },
    ...
    auth_sign_up_btn: { ar: "إنشاء حساب", en: "Sign Up" },
    auth_agree_terms: { ar: "بتسجيلك، فإنك توافق على", en: "By signing up you agree to our" },
    auth_and: { ar: "و", en: "and" },
    auth_no_account: { ar: "ليس لديك حساب؟ إنشاء حساب ←", en: "Don't have an account? Sign up →" },
    auth_has_account: { ar: "لديك حساب بالفعل؟ تسجيل الدخول ←", en: "Already have an account? Sign in →" },
